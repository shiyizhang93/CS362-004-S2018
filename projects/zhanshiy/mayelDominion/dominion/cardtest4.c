...
//It is to test the village card effect
...
int main (int argc, char** argv) {
    ...
    endState = startState;
    printf("Test suite for card village effect\n");
    for (playerNum = 0; playerNum < numPlayers; playerNum++) {
	    cardEffect(village, choice1, choice2, choice3, &endState, handFlag, &bonus);
      ...
      expectedVal = startState.deckCount[playerNum] - numNewCardHand;
      ...
      expectedVal = startState.numActions + numAction;
	    testVal = endState.numActions;
	    showTestResult(expectedVal, testVal, "Player actions number");
